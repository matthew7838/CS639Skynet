        ...
        <el-form :model="user" style="width: 80%" :rules="rules" ref="loginRef">
          ...
          <el-form-item prop="code">
            <div style="display: flex">
              <el-input placeholder="Please Enter Valid Code" prefix-icon="el-icon-circle-check" size="medium" style="flex: 1" v-model="user.code"></el-input>
          ...
          <div style="display: flex">
            <div style="flex: 1">Don't have account? <span style="color: #0f9876; cursor: pointer" @click="$router.push('/register')">Registration</span></div>
          </div>
        </el-form>
      </div>
    </div>
